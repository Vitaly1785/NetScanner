...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (allPorts.size()/MIN_PORTS_PER_THREAD > MAX_THREADS ) {
            ...
            getCount(PORTS_PER_THREAD, threadPorts);
        } else {
            List<Integer> threadPorts = new ArrayList<>();
            getCount(MIN_PORTS_PER_THREAD, threadPorts);
        }
    ...
    private static void getCount(int PORTS_PER_THREAD, List<Integer> threadPorts) {
